...
\Phi(x,y) := \left( 1-2x-2y, \frac{y-x}{x+y} \right)
\end{equation}
%
...
\label{h11}%
h^{\alpha,\beta,\gamma}_{1,1} & = \frac{(\alpha+\beta+2)(\alpha+1)(\beta+1)}{(\alpha+\beta+\gamma+3)(\alpha+\beta+\gamma+4)} \, h^{\alpha,\beta,\gamma}_{0,0}.
\end{align}
%
By \eqref{JacobiSquaredNormFirst} and \eqref{JacobiSquaredNormGeneral}, for $n \geq 2$,
%
\begin{equation}\label{hn0}
h^{\alpha,\beta,\gamma}_{n,0} = \frac{2n+\alpha+\beta+\gamma}{2n+\alpha+\beta+\gamma+2} \frac{(n+\alpha+\beta+1)(n+\gamma)}{n \, (n+\alpha+\beta+\gamma+1)} \, h^{\alpha,\beta,\gamma}_{n-1,0}.
\end{equation}
%
By \eqref{JacobiSquaredNormFirst} and \eqref{JacobiSquaredNormGeneral}, for $n \geq 2$,
%
